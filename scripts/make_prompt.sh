...
readonly SRC_DIR="./tkstatistics"
readonly TMP_ROOT="/tmp"
readonly TMP_DIR="${TMP_ROOT}/tkstatistics"
readonly OUTPUT_MD_BASENAME="tkstatistics.flat.md"
...
# Run strip-docs for each subdirectory of tmp/tkstatistics
...
# in the generated Markdown (tkstatistics.flat.md). Other code fences remain untouched.
