# tkstatistics/app/main.py (Updated)
...
from tkstatistics.core import specs  # <-- Import specs module
...
from .project_explorer import ProjectExplorer  # <-- Import the new explorer
...
class App(tk.Tk):
    ...
    def _create_widgets(self):
        ...
        # Right pane: A vertical paned window for grid and output
    ...
    def _set_project(self, project: Project):
        ...
        # Automatically load the first dataset, if any
    ...
    def _import_csv(self):
        # ... updated to refresh the explorer ...
        if not self.project:
        ...
        try:
            ...
            self.project_explorer.populate(self.project)  # Refresh explorer
    ...
    def _run_descriptives(self):
        ...
        for var_name in selected_vars:
            ...
            self.project.save_analysis(spec)  # Save it!
        ...
        self.project_explorer.populate(self.project)  # Refresh to show new analysis

    # ... (Similar updates needed for _run_simple_regression and _run_multiple_regression) ...
    ...
    # --- (The rest of the boilerplate methods are included for completeness but are mostly unchanged) ---
